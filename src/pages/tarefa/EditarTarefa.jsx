...
const EditarTarefa = ({handleCloseEditar, idTarefaSelecionada, tarefas, tarefa, setTarefas}) =>{
  ...
  useEffect(() => {
    ...
    setMateriaTarefa(tarefa.materiaTarefa);
        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text">Parcial</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="materiaTarefa">Materia</InputLabel>
                <Select
                  id="tmateriaTarefa"
                  value={materiaTarefa}
                  label="materia"
                ...
                >
                  <MenuItem value={'Prática Integradora Tecnologias Disruptivas'}>Prática Integradora Tecnologias Disruptivas</MenuItem>
                  <MenuItem value={'Tecnologias Inovadoras de Desenvolvimento de Sistemas'}>Tecnologias Inovadoras de Desenvolvimento de Sistemas</MenuItem>
            ...
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_materia">Status</InputLabel>
                <Select
                  id="tarefa_status"
                  value={statusTarefa}
                  label="Status"
